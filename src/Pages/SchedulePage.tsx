  ...
  return ( <>
    <div className="nav_wrapper">
        ...
        <div className="right_nav">
            <p className="name">Овденко Н.Б.</p>
    ...
    <div className="days_wrapper">
        <div className="day" id="first-day">
            ...
            <div className="lessons_wrapper">
                <div className="lesson">
                    ...
                    <div className="right">
                        <div className="time">
                            <input type="time" className="les_time" />
                            <p className="wall">:</p>
                            <input type="time" className="les_time" />
                        </div>
                        <div className="remove">
                            <svg>
                                <img className="add" src={removeImg} />
                            </svg>
                        </div>
                    </div>
                </div>
            ...
            <div className="add">
                <img src={plusImg} className="remove"/>
            </div>
        </div>
        <div className="day" id="second-day">
            <div className="day_top">
                <p className="static">Расписание</p>
        ...
        <div className="day" id="third-day">
            <div className="day_top">
                <p className="static">Расписание</p>
        ...
        <div className="day" id="fourth-day">
            <div className="day_top">
                <p className="static">Расписание</p>
        ...
        <div className="day" id="fiveth-day">
            <div className="day_top">
                <p className="static">Расписание</p>
        ...
        <div className="day" id="sixth-day">
            <div className="day_top">
                <p className="static">Расписание</p>
        ...
        <div className="day" id="seventh-day">
            <div className="day_top">
                <p className="static">Расписание</p>
